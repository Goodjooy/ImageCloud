...
* ```/sign-in```
  ...
  * 参数列表
      ...
      | :--: | :-----: | :-----: | :--: | :-----: | :------: |
      | GET**removed** | null | null | 获得简陋登录界面 | 所有人| ```html``` |
...
* ```/sign-up```
  ...
  * 参数列表
      | 方法 | 参数列表 | 参数描述 | 功能 | 用户限制 | 响应模型 |
      | :--: | :--: | :--: | :--: | :--: | :------: |  
      | GET**removed** | null | null | 获得简陋注冊界面 | 所有人| ```html``` |
...
* ```/reset-paswd```
  ...
  * 參數列表
      | 方法 | 参数列表 | 参数描述 | 功能 | 用户限制 | 响应模型 |
      | :--: | :--: | :--: | :--: | :--: | :------: |  
      | GET**removed** | null |null| 獲得簡單的更改密碼界面 | USER | ```html``` |
...
* ```/user-verify```
  ...
  * 參數列表
      | 方法 | 参数列表 | 参数描述 | 功能 | 用户限制 | 响应模型 |
      | :--: | :--: | :--: | :--: | :--: | :------: |  
      | GET**removed** | null | null | 获得简单的用户邮箱验证界面 | USER | ```html``` |
...
* ```/upload```
  ...
  * 參數列表
      | 方法 | 参数列表 | 参数描述 |功能 | 用户限制 | 响应模型 |
      | :--: | :--: | :--: | :--: | :--: | :------: |  
      | GET**removed** | null |null| 獲得簡單的文件上傳界面 | USER | ```html``` |
* ```/headup```
  * 只供測試使用的用户头像上傳接口
  * 參數列表
      | 方法 | 参数列表 | 参数描述 |功能 | 用户限制 | 响应模型 |
      | :--: | :--: | :--: | :--: | :--: | :------: |  
      | GET**removed** | null |null| 获得简单的用户头像上传界面 | USER | ```html``` |
* ```/headImagePreview```
  * 只供測試使用的用户头像预览接口
  * 參數列表
      | 方法 | 参数列表 | 参数描述 |功能 | 用户限制 | 响应模型 |
      | :--: | :--: | :--: | :--: | :--: | :------: |  
      | GET**removed** | null |null| 获得简单的用户头像预览界面 | USER | ```html``` |
...
* ```/file```
  ...
  * 參數列表
      | 方法 | 参数列表 | 参数描述 | 功能 | 用户限制 | 响应模型 |
      | :--: | :--: | :--: | :--: | :--: |:------: |
      | GET | path={*targetPath*}&<br>withHidden={*withHiddenItems*:**false**}&<br>sort={*sortDependentBy*:**name**}&<br>reverse={*reverseSort*:**false**} | path->要獲取的文件夾或者文件信息的路徑;<br>withHidden(boolean)->是否忽略隐藏文件;<br>sort->排序方式；<br>reverse->是否反转排序 | 獲取指定文件夾或文件信息<br>*路徑以```/root```開頭*<br>*可用的排序方法<br>{`name`, `createTime`,`modifyTime`}* | USER | ```Result<Item>``` |
